...
const Contact = ({ messagesLink, dashLink }: ContactProps) => {
    return (
        <div className='w-full'>
            ...
            <div className='grid grid-cols-1 lg:grid-cols-2 gap-5'>
                <div className='shadow-[.2px_.2px_3px_1px] dark:shadow-slate-700 h-[13rem] w-full shadow-gray-100 flex justify-center items-center rounded-lg p-5'>
                    <div className='text-center flex justify-center w-full'>
                        <div className='w-full space-y-4'>
                            <Link href={messagesLink} aria-label='home' className='bg-blue-100 text-blue-500 rounded-full flex items-center justify-center border w-20 h-20 mx-auto'>
                ...
                <div className='shadow-[.2px_.2px_3px_1px] dark:shadow-slate-700 h-[13rem] w-full shadow-gray-100 flex justify-center items-center rounded-lg p-5'>
                    <div className='text-center flex justify-center w-full'>
                        <div className='w-full space-y-4'>
                            <Link href={dashLink} className='bg-blue-100 text-blue-500 rounded-full flex items-center justify-center border w-20 h-20 mx-auto'>
