    ...
    <>
      <div className='container px-5 max-w-5xl flex gap-1 place-content-center mt-[2rem] md:mt-[6rem] mb-5 md:mb-28'>
        <div className='container px-3 max-w-md md:mt-16'>
          <div className='md:border rounded-lg  border-gray-300 md:max-w-[90%] ss:px-5 md:px-6 items-center text-center md:bg-white'>
            <Link href="/">
          ...
          <div className='md:border rounded-lg max-w-[90%] border-gray-300 justify-center flex mt-5 md:bg-white'>
            <p className="py-5 inline">Don't have an account? <Link href="/signup" className='font-semibold text-blue-400'>Sign up</Link></p>
          </div>
        </div>
      </div>
    </>
