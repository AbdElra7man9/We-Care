            ...
            <form className='flex flex-col' onSubmit={handleSubmit}>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-5'>
                    <div>
                        ...
                        <select onChange={handleChange} name='department' className='inputfield w-full'>
                            <option>Eye</option>
                        </select>
                    </div>
                    <div>
                        <label className='text-sm text-gray-500 font-medium text-start my-1'>Your password</label>
                        <select onChange={handleChange} name='doctor' className='inputfield w-full'>
                            <option>Eye</option>
                        </select>
                    </div>
                </div>
...
export default ClincAppointment
