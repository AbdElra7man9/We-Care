    ...
    return (
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-10 container max-w-7xl py-96 lg:py-72'>
            <div className='flex justify-center'>
                <img src='https://shreethemes.in/doctris/layouts/assets/images/about/about-2.png' alt='' />
            </div>
            <div className='h-full px-3 flex items-center'>
                <div className='space-y-5'>
                    <h3 className='text-2xl font-medium'>About Our Treatments</h3>
                    <p className='text-gray-400 leading-loose'>Great doctor if you need your family member to get effective immediate assistance, examination, emergency treatment or a simple consultation. Thank you.
                    ...
                    <button className='bg-blue-500 text-white rounded-lg p-3 px-4 font-medium inline'><span className='flex gap-3 items-center'>Read More<BsArrowRight /></span></button>
